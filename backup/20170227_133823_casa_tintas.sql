...
DROP TABLE IF EXISTS `bases_tinta`;
...
CREATE TABLE `bases_tinta` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_bases_tinta_tintas1_idx` (`id_tinta`),
  KEY `fk_bases_tinta_produtos1_idx` (`id_produto`),
  KEY `fk_bases_tinta_unidades1_idx` (`sigla_unidade`),
  CONSTRAINT `fk_bases_tinta_produtos1` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_bases_tinta_tintas1` FOREIGN KEY (`id_tinta`) REFERENCES `tintas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_bases_tinta_unidades1` FOREIGN KEY (`sigla_unidade`) REFERENCES `unidades` (`sigla`) ON DELETE NO ACTION ON UPDATE CASCADE
...
LOCK TABLES `bases_tinta` WRITE;
/*!40000 ALTER TABLE `bases_tinta` DISABLE KEYS */;
INSERT INTO `bases_tinta` VALUES (1,1,9,'4100',2102.500,'gr','2016-10-24 03:00:37','2016-10-24 03:00:37'),(2,1,10,'4840',2.200,'gr','2016-10-24 03:02:31','2016-10-24 03:02:31'),(3,1,11,'4652',2.200,'gr','2016-10-24 03:06:27','2016-10-24 03:31:59'),(5,1,12,'4700',2.600,'gr','2016-10-24 03:30:19','2016-10-24 03:31:02'),(6,1,13,'4000',1558.900,'gr','2016-10-24 03:30:36','2016-10-24 03:31:14'),(7,1,14,'7012',74.900,'gr','2016-10-24 03:31:25','2016-10-24 03:31:25'),(8,2,39,'4260',1399.000,'gr','2016-11-16 14:25:30','2016-11-16 14:25:30'),(9,2,10,'4840',15.300,'gr','2016-11-16 14:25:45','2016-11-16 14:25:45'),(10,2,9,'4100',46.200,'gr','2016-11-16 14:26:00','2016-11-16 14:26:00'),(11,2,37,'4232',793.000,'gr','2016-11-16 14:26:54','2016-11-16 14:26:54'),(12,2,13,'4000',985.400,'gr','2016-11-16 14:27:22','2016-11-16 14:27:22'),(13,2,14,'7012',66.100,'gr','2016-11-16 14:27:34','2016-11-16 14:27:34'),(14,3,13,'4000',2051.800,'gr','2016-11-16 14:32:39','2016-11-16 14:32:39'),(15,3,9,'4100',1446.300,'gr','2016-11-16 14:32:58','2016-11-16 14:32:58'),(16,3,10,'4840',3.700,'gr','2016-11-16 14:33:11','2016-11-16 14:33:11'),(17,3,42,'4432',6.000,'gr','2016-11-16 14:34:02','2016-11-16 14:34:02'),(18,3,14,'7012',71.600,'gr','2016-11-16 14:34:14','2016-11-16 14:34:14'),(19,4,13,'4000',1940.200,'gr','2016-11-16 14:37:04','2016-11-16 14:37:04'),(20,4,45,'4621',775.900,'gr','2016-11-16 14:37:15','2016-11-16 14:37:15'),(21,4,10,'4840',20.800,'gr','2016-11-16 14:37:28','2016-11-16 14:37:28'),(22,4,9,'4100',116.000,'gr','2016-11-16 14:38:41','2016-11-16 14:38:41'),(23,4,44,'4560',354.800,'gr','2016-11-16 14:38:54','2016-11-16 14:38:54'),(24,4,14,'7012',65.500,'gr','2016-11-16 14:39:13','2016-11-16 14:39:13');
/*!40000 ALTER TABLE `bases_tinta` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `categorias_produto` VALUES (1,'base de tinta','2016-10-03 18:49:19','2016-10-03 18:50:38'),(2,'tinta produzida','2016-10-03 18:49:19','2016-10-03 18:50:46'),(3,'embalagem','2016-10-08 16:44:44','2016-10-24 15:19:50'),(4,'verniz automotivo PU','2016-10-08 16:44:53','2016-10-08 16:46:11'),(5,'esmalte sintético','2016-10-08 16:45:04','2016-10-08 16:45:04'),(10,'categoria produto 01','2016-10-08 16:52:48','2016-10-08 16:52:48'),(11,'categoria produto 02','2016-10-08 16:52:55','2016-10-08 16:52:55'),(12,'lixa','2016-10-30 00:37:32','2016-10-30 00:37:32');
...
DROP TABLE IF EXISTS `categorias_tinta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `categorias_tinta` WRITE;
/*!40000 ALTER TABLE `categorias_tinta` DISABLE KEYS */;
INSERT INTO `categorias_tinta` VALUES (1,'metálico','2016-10-03 18:48:17','2016-10-03 18:48:17'),(2,'liso/sólido','2016-10-03 18:48:17','2016-10-08 16:57:35'),(3,'perolizado','2016-10-03 18:48:24','2016-10-03 18:48:24'),(7,'cat tinta 01','2016-10-08 17:17:04','2016-10-08 17:17:04'),(8,'cat tinta 02','2016-10-08 17:17:08','2016-10-08 17:17:08');
/*!40000 ALTER TABLE `categorias_tinta` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `compras` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_compras_cfop1_idx` (`cfop`),
  KEY `fk_compras_pessoas1_idx` (`doc_principal_fornecedor`),
  KEY `fk_compras_pessoas2_idx` (`doc_principal_transportadora`),
  CONSTRAINT `fk_compras_cfop1` FOREIGN KEY (`cfop`) REFERENCES `cfop` (`codigo`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_compras_pessoas1` FOREIGN KEY (`doc_principal_fornecedor`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_compras_pessoas2` FOREIGN KEY (`doc_principal_transportadora`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `configuracoes` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='configurações do sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `configuracoes` VALUES (1,'Simples nacional padrão','5.47','2016-10-31 12:25:38'),(2,'Comissão padrão','0.75','2016-11-01 14:37:23'),(3,'Modo padrão de produção de tinta','0','2016-10-31 16:13:24'),(4,'Quantidade padrão de produção de tinta','0.9','2016-11-01 14:36:24'),(5,'Cliente padrão de vendas','00000000000','2016-10-31 15:28:42');
...
CREATE TABLE `contas_pagar` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_contas_pagar_pessoas1_idx` (`doc_principal_fornecedor`),
  KEY `fk_contas_pagar_compras1_idx` (`id_compra`),
  CONSTRAINT `fk_contas_pagar_compras1` FOREIGN KEY (`id_compra`) REFERENCES `compras` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_contas_pagar_pessoas1` FOREIGN KEY (`doc_principal_fornecedor`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `contas_receber` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_contas_receber_pessoas1_idx` (`doc_principal_cliente`),
  KEY `fk_contas_receber_vendas1_idx` (`id_venda`),
  CONSTRAINT `fk_contas_receber_pessoas1` FOREIGN KEY (`doc_principal_cliente`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_contas_receber_vendas1` FOREIGN KEY (`id_venda`) REFERENCES `vendas` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `contatos` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_contatos_pessoas1_idx` (`doc_principal_pessoa`),
  CONSTRAINT `fk_contatos_pessoas1` FOREIGN KEY (`doc_principal_pessoa`) REFERENCES `pessoas` (`doc_principal`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contatos` VALUES (1,'43899351193',0,'rua 1,500,centro,18480000',1,'2016-09-20 17:35:37','2016-11-14 02:36:59');
...
DROP TABLE IF EXISTS `controle_cheque_cartao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `controle_cheque_cartao` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_controle_cheque_cartao_pessoas1_idx` (`doc_principal_pessoa`),
  KEY `fk_controle_cheque_cartao_contas_receber1_idx` (`id_conta_receber`),
  CONSTRAINT `fk_controle_cheque_cartao_contas_receber1` FOREIGN KEY (`id_conta_receber`) REFERENCES `contas_receber` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_controle_cheque_cartao_pessoas1` FOREIGN KEY (`doc_principal_pessoa`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `controle_cheque_cartao`
--

LOCK TABLES `controle_cheque_cartao` WRITE;
/*!40000 ALTER TABLE `controle_cheque_cartao` DISABLE KEYS */;
/*!40000 ALTER TABLE `controle_cheque_cartao` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `despesas_lancamentos_caixa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `despesas_lancamentos_caixa` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `doc_principal_fornecedor` (`doc_principal_fornecedor`),
  KEY `id_item_caixa` (`id_item_caixa`),
  CONSTRAINT `fk_doc_principal_fornecedor` FOREIGN KEY (`doc_principal_fornecedor`) REFERENCES `pessoas` (`doc_principal`) ON UPDATE CASCADE,
  CONSTRAINT `fk_id_item_caixa` FOREIGN KEY (`id_item_caixa`) REFERENCES `itens_caixa` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='despesas(conta água...) e mov. bancário(juros, taxa...)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `despesas_lancamentos_caixa`
--

LOCK TABLES `despesas_lancamentos_caixa` WRITE;
/*!40000 ALTER TABLE `despesas_lancamentos_caixa` DISABLE KEYS */;
/*!40000 ALTER TABLE `despesas_lancamentos_caixa` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `formas_pagamento` VALUES (1,'a vista',0,1,0,-5.000,'2016-10-03 18:36:43','2016-11-08 11:56:52'),(2,'crediário',3,1,30,NULL,'2016-10-03 18:37:10','2016-10-03 18:37:10'),(3,'cheque 3x',1,3,30,5.000,'2016-10-03 18:38:07','2016-10-03 18:57:33'),(4,'cartao a vista',2,1,3,0.000,'2016-10-03 18:38:52','2016-11-08 11:58:50'),(5,'crediário especial',3,3,30,5.000,'2016-10-03 18:39:48','2016-10-03 18:39:48');
...
CREATE TABLE `historico` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_historico_usuarios1_idx` (`nome_usuario`),
  KEY `id_tarefa` (`id_tarefa`),
  CONSTRAINT `fk_historico_tarefa_1` FOREIGN KEY (`id_tarefa`) REFERENCES `tarefas` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_historico_usuarios1` FOREIGN KEY (`nome_usuario`) REFERENCES `usuarios` (`nome`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `historico` VALUES (1,'admin','2017-02-27 16:30:55',21,NULL,'acessado tarefa'),(2,'admin','2017-02-27 16:31:01',5,NULL,'acessado tarefa'),(3,'admin','2017-02-27 16:31:30',18,NULL,'acessado tarefa'),(4,'admin','2017-02-27 16:31:57',22,NULL,'fechado o sistema'),(5,'admin','2017-02-27 16:32:11',21,NULL,'acessado tarefa'),(6,'admin','2017-02-27 16:32:18',27,NULL,'acessado tarefa'),(7,'admin','2017-02-27 16:32:23',22,NULL,'fechado o sistema'),(8,'admin','2017-02-27 16:37:46',21,NULL,'acessado tarefa'),(9,'admin','2017-02-27 16:37:56',25,NULL,'acessado tarefa');
...
DROP TABLE IF EXISTS `itens_caixa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `itens_caixa` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_itens_caixa_caixas1_idx` (`id_caixa`),
  CONSTRAINT `fk_itens_caixa_caixas1` FOREIGN KEY (`id_caixa`) REFERENCES `caixas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `itens_caixa`
--

LOCK TABLES `itens_caixa` WRITE;
/*!40000 ALTER TABLE `itens_caixa` DISABLE KEYS */;
/*!40000 ALTER TABLE `itens_caixa` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `itens_compras` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_itens_compras_compras1_idx` (`id_compra`),
  KEY `fk_itens_compras_produtos1_idx` (`id_produto`),
  CONSTRAINT `fk_itens_compras_compras1` FOREIGN KEY (`id_compra`) REFERENCES `compras` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_itens_compras_produtos1` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `itens_vendas` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_itens_vendas_vendas1_idx` (`id_venda`),
  KEY `fk_itens_vendas_produtos1_idx` (`id_produto`),
  CONSTRAINT `fk_itens_vendas_produtos1` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_itens_vendas_vendas1` FOREIGN KEY (`id_venda`) REFERENCES `vendas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `lancamentos_conta_pagar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lancamentos_conta_pagar` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_lancamentos_conta_pagar_contas_pagar1_idx` (`id_conta_pagar`),
  KEY `fk_lancamentos_conta_pagar_itens_caixa1_idx` (`id_item_caixa`),
  CONSTRAINT `fk_lancamentos_conta_pagar_contas_pagar1` FOREIGN KEY (`id_conta_pagar`) REFERENCES `contas_pagar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_lancamentos_conta_pagar_itens_caixa1` FOREIGN KEY (`id_item_caixa`) REFERENCES `itens_caixa` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lancamentos_conta_pagar`
--

LOCK TABLES `lancamentos_conta_pagar` WRITE;
/*!40000 ALTER TABLE `lancamentos_conta_pagar` DISABLE KEYS */;
/*!40000 ALTER TABLE `lancamentos_conta_pagar` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `lancamentos_conta_receber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lancamentos_conta_receber` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_lancamentos_conta_receber_contas_receber1_idx` (`id_conta_receber`),
  KEY `fk_lancamentos_conta_receber_itens_caixa1_idx` (`id_item_caixa`),
  KEY `fk_lancamentos_conta_receber_formas_pagamento1_idx` (`id_forma_pagamento`),
  CONSTRAINT `fk_lancamentos_conta_receber_contas_receber1` FOREIGN KEY (`id_conta_receber`) REFERENCES `contas_receber` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_lancamentos_conta_receber_formas_pagamento1` FOREIGN KEY (`id_forma_pagamento`) REFERENCES `formas_pagamento` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_lancamentos_conta_receber_itens_caixa1` FOREIGN KEY (`id_item_caixa`) REFERENCES `itens_caixa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lancamentos_conta_receber`
--

LOCK TABLES `lancamentos_conta_receber` WRITE;
/*!40000 ALTER TABLE `lancamentos_conta_receber` DISABLE KEYS */;
/*!40000 ALTER TABLE `lancamentos_conta_receber` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `lancamentos_controle_cheque_cartao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lancamentos_controle_cheque_cartao` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_lancamentos_controle_cheque_cartao_controle_cheque_carta_idx` (`id_controle_cheque_cartao`),
  CONSTRAINT `fk_lancamentos_controle_cheque_cartao_controle_cheque_cartao1` FOREIGN KEY (`id_controle_cheque_cartao`) REFERENCES `controle_cheque_cartao` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lancamentos_controle_cheque_cartao`
--

LOCK TABLES `lancamentos_controle_cheque_cartao` WRITE;
/*!40000 ALTER TABLE `lancamentos_controle_cheque_cartao` DISABLE KEYS */;
/*!40000 ALTER TABLE `lancamentos_controle_cheque_cartao` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `localidades` VALUES (18480000,'Itaporanga','SP');
...
CREATE TABLE `marcas` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_marcas_pessoas1_idx` (`doc_principal_fornecedor`),
  CONSTRAINT `fk_marcas_pessoas1` FOREIGN KEY (`doc_principal_fornecedor`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE
...
INSERT INTO `marcas` VALUES (1,'marca a','02333444000166','2016-10-08 22:38:48','2016-10-25 23:15:32'),(2,'marca b','01222444000155','2016-10-08 22:38:48','2016-10-25 23:15:23'),(3,'wanda','01222444000155','2016-10-24 01:13:55','2016-10-24 01:13:55'),(4,'3M','01222444000155','2016-10-30 00:38:20','2016-10-30 00:38:20');
...
INSERT INTO `montadoras` VALUES ('fd','ford','2016-10-08 17:50:26','2016-11-16 14:28:21'),('fi','fiat','2016-10-08 17:50:10','2016-10-08 17:50:10'),('gm','general motors','2016-10-03 18:32:36','2016-10-03 18:32:36'),('vw','volkswagem','2016-10-03 18:32:36','2016-10-03 18:32:36');
...
CREATE TABLE `pessoas` (
  ...
  `data_inclusao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`doc_principal`),
  KEY `fk_pessoas_localidades1_idx` (`cep_cidade_natal`),
  CONSTRAINT `fk_pessoas_localidades1` FOREIGN KEY (`cep_cidade_natal`) REFERENCES `localidades` (`cep`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pessoas` VALUES ('01222444000155','11122233344',1,0,1,0,'Empresa teste A','teste','','',NULL,0.000,NULL,1,'2016-10-08 18:33:42','2016-11-13 23:40:41'),('02333444000166','11122233355',1,0,1,0,'Empresa teste B','teste 2','','',NULL,0.000,NULL,1,'2016-10-08 18:33:42','2016-11-13 23:40:45'),('43899351193','000000000',0,1,0,1,'admin','admin','Solteiro(a)','o próprio','2000-01-01',1000.000,18480000,1,'2016-09-19 23:08:15','2017-02-27 16:18:02');
...
DROP TABLE IF EXISTS `producao_tinta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `producao_tinta` (
  ...
  `valor_total` decimal(10,3) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_producao_tinta_tintas1_idx` (`id_tinta`),
  KEY `fk_producao_tinta_produto` (`id_produto`),
  KEY `id_embalagem_producao` (`id_embalagem`),
  CONSTRAINT `fh_producao_tinta_produto1` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_producao_embalagem` FOREIGN KEY (`id_embalagem`) REFERENCES `produtos` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_producao_tinta_tintas1` FOREIGN KEY (`id_tinta`) REFERENCES `tintas` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `producao_tinta`
--

LOCK TABLES `producao_tinta` WRITE;
/*!40000 ALTER TABLE `producao_tinta` DISABLE KEYS */;
/*!40000 ALTER TABLE `producao_tinta` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `produtos` (
  ...
  KEY `fk_produtos_categorias_produto1_idx` (`id_categoria`),
  KEY `fk_produtos_marcas1_idx` (`id_marca`),
  KEY `fk_produtos_unidades1_idx` (`sigla_unidade`),
  KEY `unidade_producao` (`unidade_producao`),
  CONSTRAINT `fk_produtos_categorias_produto1` FOREIGN KEY (`id_categoria`) REFERENCES `categorias_produto` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_produtos_marcas1` FOREIGN KEY (`id_marca`) REFERENCES `marcas` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_produtos_unidades1` FOREIGN KEY (`sigla_unidade`) REFERENCES `unidades` (`sigla`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_produtos_unidades2` FOREIGN KEY (`unidade_producao`) REFERENCES `unidades` (`sigla`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produtos` VALUES (5,'Produto teste tinta produzida 1','78965452225','222.5',1,1,2.550000,'lt',1.000,890.000,'gr',1,86.780,5.000,8.080,0.000,5.470,14.400,10.000,132.045,0.750,'2018-01-01','2016-10-11 05:11:13','2016-11-01 14:36:58'),(6,'esmalte sintético branco geada anjo 3,6l',NULL,NULL,5,1,28.000000,'un',1.000,NULL,NULL,0,80.000,5.000,8.000,0.000,5.470,0.000,20.000,122.526,0.750,'2017-12-31','2016-10-11 17:47:54','2016-11-15 18:06:57'),(7,'Esmalte sintético preto cadilac 900ml','78925256568','568',5,2,24.000000,'un',1.000,NULL,NULL,0,7.890,5.000,18.000,0.000,5.470,6.000,30.000,15.958,0.750,'2018-02-01','2016-10-16 12:57:28','2016-11-01 14:36:58'),(8,'Esmalte sintético vermelho massey fergusson','7893652214','214',5,1,95.000000,'un',1.000,NULL,NULL,0,12.250,5.000,6.000,0.000,5.470,0.000,30.000,21.319,0.750,'2018-01-01','2016-10-18 12:36:08','2016-11-15 18:06:57'),(9,'Base wandacar branca 4100 ',NULL,'4100',1,3,94.330167,'lt',3.600,4285.710,'gr',1,50.000,5.000,8.000,0.000,5.470,0.000,25.000,82.146,0.750,'2018-01-01','2016-10-24 01:25:34','2016-11-16 15:25:42'),(10,'Base wandacar preto 4840',NULL,'4840',1,3,99.990449,'lt',3.600,3280.180,'gr',1,39.500,5.000,8.000,0.000,5.470,0.000,25.000,64.895,0.750,'2018-01-01','2016-10-24 01:33:49','2016-11-16 15:25:42'),(11,'Base wandacar azul beta 4652',NULL,'4652',1,3,99.994561,'lt',3.600,3923.705,'gr',1,42.000,5.000,8.000,0.000,5.470,0.000,25.000,69.003,0.750,'2018-01-01','2016-10-24 01:38:00','2016-11-16 15:25:42'),(12,'Base wandacar violeta transparente 4700',NULL,'4700',1,3,99.992259,'lt',3.600,3257.918,'gr',1,41.000,5.000,8.000,0.000,5.470,0.000,25.000,67.360,0.750,'2018-01-01','2016-10-24 01:42:29','2016-11-16 15:25:42'),(13,'Base wandacar binder 4000',NULL,'4000',1,3,93.572075,'lt',3.600,3214.285,'gr',1,40.000,5.000,8.000,0.000,5.470,0.000,25.000,65.717,0.750,'2018-01-01','2016-10-24 01:45:18','2016-11-16 15:25:42'),(14,'Base wandacar secante 7012',NULL,'7012',1,3,99.717656,'lt',3.600,3257.918,'gr',1,35.000,5.000,8.000,0.000,5.470,0.000,25.000,57.502,0.750,'2018-01-01','2016-10-24 01:47:03','2016-11-16 15:25:42'),(15,'Lata galão 3,600 lt wanda',NULL,NULL,3,3,99.000000,'un',1.000,NULL,NULL,0,3.500,5.000,0.000,0.000,5.470,0.000,40.000,6.833,0.750,'2020-12-31','2016-10-24 15:21:53','2016-11-01 14:36:58'),(16,'Lata litro 0,900 lt wanda',NULL,NULL,3,3,99.000000,'un',1.000,NULL,NULL,0,1.900,5.000,0.000,0.000,5.470,0.000,40.000,3.710,0.750,'2020-12-31','2016-10-24 15:24:03','2016-11-08 23:05:11'),(17,'Lata pote 0,250 lt wanda',NULL,NULL,3,3,100.000000,'un',1.000,NULL,NULL,0,1.000,5.000,0.000,0.000,5.470,0.000,40.000,1.952,0.750,'2020-12-31','2016-10-24 15:25:13','2016-11-01 14:36:58'),(30,'Tinta prod. branco geada volkswagem liso/sólido esmalte sintético vw40000',NULL,'vw40000',2,3,5.400000,'lt',1.000,NULL,NULL,1,44.817,0.000,0.000,0.000,5.470,0.000,32.912,73.629,0.750,'2017-10-26','2016-10-26 16:00:51','2016-11-16 15:25:42'),(31,'lixa água 320 3M',NULL,NULL,12,4,11.000000,'fl',1.000,NULL,NULL,0,0.500,0.000,0.000,0.000,5.470,0.000,50.000,1.142,0.750,'2018-01-01','2016-10-30 00:39:39','2016-11-18 14:26:28'),(32,'lixa água 150 3M',NULL,NULL,12,4,150.000000,'fl',1.000,NULL,NULL,0,2.300,0.000,0.000,0.000,5.470,0.000,50.000,5.254,0.750,'2017-01-31','2016-11-16 12:21:18','2016-11-16 23:37:23'),(33,'lixa água 400 3M',NULL,NULL,12,4,45.000000,'fl',1.000,NULL,NULL,0,0.550,0.000,0.000,0.000,5.470,0.000,50.000,1.256,0.750,'2018-01-01','2016-11-16 12:22:24','2016-11-18 14:26:53'),(34,'lixa água 1200 3M',NULL,NULL,12,4,40.000000,'fl',1.000,NULL,NULL,0,1.200,0.000,0.000,0.000,5.470,0.000,50.000,2.741,0.750,'2018-01-01','2016-11-16 12:23:23','2016-11-18 14:26:14'),(35,'lixa água 2000 3M',NULL,NULL,12,4,50.000000,'fl',1.000,NULL,NULL,0,2.300,0.000,0.000,0.000,5.470,0.000,50.000,5.254,0.750,'2018-01-01','2016-11-16 12:24:19','2016-11-16 12:24:19'),(36,'Base wandacar controlador universal de efeito 1990',NULL,'1990',1,3,20.000000,'lt',0.900,918.000,'gr',1,21.530,5.000,8.000,0.000,5.470,0.000,25.000,35.372,0.750,'2018-01-01','2016-11-16 12:28:38','2016-11-16 12:28:38'),(37,'Base wandacar laranja II 4232',NULL,'4232',1,3,100.000000,'lt',3.600,3397.000,'gr',1,45.500,5.000,8.000,0.000,5.470,0.000,25.000,74.753,0.750,'2018-01-01','2016-11-16 12:35:41','2016-11-16 12:40:25'),(38,'Base wandacar vermelho óxido 4240',NULL,'4240',1,3,100.000000,'lt',3.600,3710.000,'gr',1,41.250,5.000,8.000,0.000,5.470,0.000,25.000,67.770,0.750,'2018-01-01','2016-11-16 12:37:25','2016-11-16 12:37:25'),(39,'Base wandacar vermelho brilhante 4260',NULL,'4260',1,3,20.000000,'lt',0.900,825.000,'gr',1,26.000,5.000,8.000,0.000,5.470,0.000,25.000,42.716,0.750,'2018-01-01','2016-11-16 12:38:56','2016-11-16 12:40:07'),(40,'Base wandacar rosa transparente II 4276',NULL,'4276',1,3,100.000000,'lt',3.600,3275.000,'gr',1,40.000,5.000,8.000,0.000,5.470,0.000,25.000,65.717,0.750,'2018-01-01','2016-11-16 12:42:02','2016-11-16 12:42:02'),(41,'Base wandacar amarelo avermelhado 4424',NULL,'4424',1,3,100.000000,'lt',3.600,3450.000,'gr',1,43.000,5.000,8.000,0.000,5.470,0.000,25.000,70.646,0.750,'2018-01-01','2016-11-16 12:43:47','2016-11-16 12:43:47'),(42,'Base wandacar amarelo óxido 4432',NULL,'4432',1,3,99.995623,'lt',3.600,3700.000,'gr',1,39.500,5.000,8.000,0.000,5.470,0.000,25.000,64.895,0.750,'2018-01-01','2016-11-16 12:45:35','2016-11-16 15:24:05'),(43,'Base wandacar amarelo esverdeado 4452',NULL,'4452',1,3,100.000000,'lt',3.600,3922.000,'gr',1,38.000,5.000,8.000,0.000,5.470,0.000,25.000,62.431,0.750,'2018-01-01','2016-11-16 12:53:46','2016-11-16 12:53:46'),(44,'Base wandacar verde azulado 4560',NULL,'4560',1,3,100.000000,'lt',3.600,3336.000,'gr',1,26.800,5.000,8.000,0.000,5.470,0.000,25.000,44.030,0.750,'2018-01-01','2016-11-16 12:54:52','2016-11-16 12:54:52'),(45,'Base wandacar azul avermelhado II 4621',NULL,'4621',1,3,100.000000,'lt',3.600,3272.000,'gr',1,23.500,5.000,8.000,0.000,5.470,0.000,25.000,38.609,0.750,'2018-01-01','2016-11-16 12:56:10','2016-11-16 12:56:10'),(46,'Base wandacar violeta II 4722',NULL,'4722',1,3,100.000000,'lt',3.600,3295.000,'gr',1,27.000,5.000,8.000,0.000,5.470,0.000,25.000,44.359,0.750,'2018-01-01','2016-11-16 12:57:32','2016-11-16 12:57:32'),(47,'Tinta prod. branco star II volkswagem liso/sólido esmalte sintético vw40001',NULL,'vw40001',2,3,2.700000,'lt',1.000,NULL,NULL,1,38.956,0.000,0.000,0.000,5.470,0.000,32.914,64.003,0.750,'2017-11-16','2016-11-16 15:08:43','2016-11-16 15:24:05');
...
CREATE TABLE `promocoes` (
  ...
  CONSTRAINT `fk_promocoes_produtos1` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `rel_clientes_geral`
--

DROP TABLE IF EXISTS `rel_clientes_geral`;
/*!50001 DROP VIEW IF EXISTS `rel_clientes_geral`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rel_clientes_geral` (
  `doc_principal` tinyint NOT NULL,
  `doc_secundario` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `fantasia` tinyint NOT NULL,
  `estado_civil` tinyint NOT NULL,
  `pessoa_autorizada` tinyint NOT NULL,
  `data_nascimento` tinyint NOT NULL,
  `limite_credito` tinyint NOT NULL,
  `cep_cidade_natal` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `rel_contatos`
--

DROP TABLE IF EXISTS `rel_contatos`;
/*!50001 DROP VIEW IF EXISTS `rel_contatos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rel_contatos` (
  `id` tinyint NOT NULL,
  `doc_principal_pessoa` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_caixas`
--

DROP TABLE IF EXISTS `rep_caixas`;
/*!50001 DROP VIEW IF EXISTS `rep_caixas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_caixas` (
  `id` tinyint NOT NULL,
  `id_caixa` tinyint NOT NULL,
  `desc_caixa` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `data_abertura` tinyint NOT NULL,
  `data_fechamento` tinyint NOT NULL,
  ...
  `desc_especie` tinyint NOT NULL,
  `valor_dh` tinyint NOT NULL,
  `valor_ch` tinyint NOT NULL,
  `valor_ct` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `rep_clientes_geral`
--

DROP TABLE IF EXISTS `rep_clientes_geral`;
/*!50001 DROP VIEW IF EXISTS `rep_clientes_geral`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_clientes_geral` (
  `doc_principal` tinyint NOT NULL,
  `doc_secundario` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_comissao`
--

DROP TABLE IF EXISTS `rep_comissao`;
/*!50001 DROP VIEW IF EXISTS `rep_comissao`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_comissao` (
  `data` tinyint NOT NULL,
  `data_pesquisa` tinyint NOT NULL,
  `id_venda` tinyint NOT NULL,
  `nome_usuario` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `quantidade` tinyint NOT NULL,
  `valor_unitario` tinyint NOT NULL,
  `valor_total` tinyint NOT NULL,
  `comissao` tinyint NOT NULL,
  `valor_comissao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `rep_compras`
--

DROP TABLE IF EXISTS `rep_compras`;
/*!50001 DROP VIEW IF EXISTS `rep_compras`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_compras` (
  `id` tinyint NOT NULL,
  `data_nf_entrada` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `doc_principal_fornecedor` tinyint NOT NULL,
  `nome_fornecedor` tinyint NOT NULL,
  `doc_principal_transportadora` tinyint NOT NULL,
  `nome_transportadora` tinyint NOT NULL,
  `numero_nf_entrada` tinyint NOT NULL,
  `serie_nf_entrada` tinyint NOT NULL,
  `cfop` tinyint NOT NULL,
  `data_emissao_nf_entrada` tinyint NOT NULL,
  `valor_frete` tinyint NOT NULL,
  `valor_total` tinyint NOT NULL,
  `ipi_total` tinyint NOT NULL,
  `icms_st_total` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `rep_contatos`
--

DROP TABLE IF EXISTS `rep_contatos`;
/*!50001 DROP VIEW IF EXISTS `rep_contatos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_contatos` (
  `id` tinyint NOT NULL,
  `doc_principal_pessoa` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_controle_ch_ct`
--

DROP TABLE IF EXISTS `rep_controle_ch_ct`;
/*!50001 DROP VIEW IF EXISTS `rep_controle_ch_ct`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_controle_ch_ct` (
  `id` tinyint NOT NULL,
  `numero_parcela` tinyint NOT NULL,
  `id_controle_cheque_cartao` tinyint NOT NULL,
  `doc_principal_pessoa` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `dados_adicionais` tinyint NOT NULL,
  `valor_total` tinyint NOT NULL,
  `quantidade_parcelas` tinyint NOT NULL,
  `especie` tinyint NOT NULL,
  `valor_parcela` tinyint NOT NULL,
  `data_vencimento` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_despesas`
--

DROP TABLE IF EXISTS `rep_despesas`;
/*!50001 DROP VIEW IF EXISTS `rep_despesas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_despesas` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `doc_principal_fornecedor` tinyint NOT NULL,
  `nome_fornecedor` tinyint NOT NULL,
  `id_caixa` tinyint NOT NULL,
  `id_item_caixa` tinyint NOT NULL,
  `numero` tinyint NOT NULL,
  `valor` tinyint NOT NULL,
  `movimento` tinyint NOT NULL,
  `desc_movimento` tinyint NOT NULL,
  `valor_debito` tinyint NOT NULL,
  `valor_credito` tinyint NOT NULL,
  `valor_movimento` tinyint NOT NULL,
  `data_vencimento` tinyint NOT NULL,
  `data_pagamento` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
...
--
-- Temporary table structure for view `rep_fornecedores_geral`
--

DROP TABLE IF EXISTS `rep_fornecedores_geral`;
/*!50001 DROP VIEW IF EXISTS `rep_fornecedores_geral`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_fornecedores_geral` (
  `doc_principal` tinyint NOT NULL,
  `doc_secundario` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_funcionarios_geral`
--

DROP TABLE IF EXISTS `rep_funcionarios_geral`;
/*!50001 DROP VIEW IF EXISTS `rep_funcionarios_geral`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_funcionarios_geral` (
  `doc_principal` tinyint NOT NULL,
  `doc_secundario` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_historico`
--

DROP TABLE IF EXISTS `rep_historico`;
/*!50001 DROP VIEW IF EXISTS `rep_historico`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_historico` (
  `id` tinyint NOT NULL,
  `nome_usuario` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `date_pesquisa` tinyint NOT NULL,
  `id_tarefa` tinyint NOT NULL,
  `descricao_tarefa` tinyint NOT NULL,
  `codigo` tinyint NOT NULL,
  `descricao_historico` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `rep_itens_venda`
--

DROP TABLE IF EXISTS `rep_itens_venda`;
/*!50001 DROP VIEW IF EXISTS `rep_itens_venda`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_itens_venda` (
  `id` tinyint NOT NULL,
  `id_venda` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_lancamentos_conta_pagar_fornecedor`
--

DROP TABLE IF EXISTS `rep_lancamentos_conta_pagar_fornecedor`;
/*!50001 DROP VIEW IF EXISTS `rep_lancamentos_conta_pagar_fornecedor`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_lancamentos_conta_pagar_fornecedor` (
  `id` tinyint NOT NULL,
  `id_conta_pagar` tinyint NOT NULL,
  `id_item_caixa` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_lancamentos_conta_receber`
--

DROP TABLE IF EXISTS `rep_lancamentos_conta_receber`;
/*!50001 DROP VIEW IF EXISTS `rep_lancamentos_conta_receber`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_lancamentos_conta_receber` (
  `id` tinyint NOT NULL,
  `id_conta_receber` tinyint NOT NULL,
  `id_item_caixa` tinyint NOT NULL,
  `id_venda` tinyint NOT NULL,
  `valor` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_lancamentos_conta_receber_cliente`
--

DROP TABLE IF EXISTS `rep_lancamentos_conta_receber_cliente`;
/*!50001 DROP VIEW IF EXISTS `rep_lancamentos_conta_receber_cliente`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_lancamentos_conta_receber_cliente` (
  `id` tinyint NOT NULL,
  `id_conta_receber` tinyint NOT NULL,
  `id_item_caixa` tinyint NOT NULL,
  `id_venda` tinyint NOT NULL,
  `doc_principal_cliente` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_pessoas`
--

DROP TABLE IF EXISTS `rep_pessoas`;
/*!50001 DROP VIEW IF EXISTS `rep_pessoas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_pessoas` (
  `doc_principal` tinyint NOT NULL,
  `doc_secundario` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_producao_tinta`
--

DROP TABLE IF EXISTS `rep_producao_tinta`;
/*!50001 DROP VIEW IF EXISTS `rep_producao_tinta`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_producao_tinta` (
  `id` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `id_tinta` tinyint NOT NULL,
  `nome_tinta` tinyint NOT NULL,
  `codigo_tinta` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome_produto` tinyint NOT NULL,
  `id_embalagem` tinyint NOT NULL,
  `descricao_embalagem` tinyint NOT NULL,
  `quantidade` tinyint NOT NULL,
  `unidade` tinyint NOT NULL,
  `valor_total` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Temporary table structure for view `rep_produtos`
--

DROP TABLE IF EXISTS `rep_produtos`;
/*!50001 DROP VIEW IF EXISTS `rep_produtos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_produtos` (
  `id` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  ...
  `sigla_unidade` tinyint NOT NULL,
  `quantidade_unitaria` tinyint NOT NULL,
  `quantidade_producao` tinyint NOT NULL,
  `unidade_producao` tinyint NOT NULL,
  `fracionado` tinyint NOT NULL,
  `desc_fracionado` tinyint NOT NULL,
  `preco_custo` tinyint NOT NULL,
  `ipi` tinyint NOT NULL,
  `icms_st` tinyint NOT NULL,
  `diferenca_icms` tinyint NOT NULL,
  `frete` tinyint NOT NULL,
  `custo_final` tinyint NOT NULL,
  `margem` tinyint NOT NULL,
  `simples_nacional` tinyint NOT NULL,
  `comissao` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_usuarios`
--

DROP TABLE IF EXISTS `rep_usuarios`;
/*!50001 DROP VIEW IF EXISTS `rep_usuarios`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_usuarios` (
  `nome` tinyint NOT NULL,
  `administrador` tinyint NOT NULL,
  `descricao_tipo` tinyint NOT NULL,
  `ativo` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `rep_vendas`
--

DROP TABLE IF EXISTS `rep_vendas`;
/*!50001 DROP VIEW IF EXISTS `rep_vendas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_vendas` (
  `id` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `doc_principal_cliente` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
...
--
-- Temporary table structure for view `rep_vendas_total`
--

DROP TABLE IF EXISTS `rep_vendas_total`;
/*!50001 DROP VIEW IF EXISTS `rep_vendas_total`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `rep_vendas_total` (
  `id_venda` tinyint NOT NULL,
  `data_completa` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `hora` tinyint NOT NULL,
  `doc_principal_cliente` tinyint NOT NULL,
  `nome_cliente` tinyint NOT NULL,
  `vendedor` tinyint NOT NULL,
  `valor_venda` tinyint NOT NULL,
  `valor_parcela` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `tarefas` VALUES (1,'iFrmCadCategoriaProd','cadastro de categoria de produto'),(2,'iFrmCadCategoriaTinta','cadastro de categoria de tinta'),(3,'iFrmCadMarca','cadastro de marca'),(4,'iFrmCadMontadora','cadastro de montadora'),(5,'iFrmCadProduto','cadastro de produto'),(6,'iFrmCadPromocoes','cadastro de promoção'),(7,'iFrmCadTinta','cadastro de tinta'),(8,'iFrmCadTipoTinta','cadastro de tipo de tinta'),(9,'iFrmCadUnidade','cadastro de unidade'),(10,'iFrmCompra','compra'),(11,'iFrmProdTinta','produção de tinta'),(12,'iFrmVendas','venda'),(13,'iFrmCaixa','caixa'),(14,'iFrmChequeCartao','controle de cheque e cartão'),(15,'iFrmContasPagar','controle de conta a pagar'),(16,'iFrmContasReceber','controle de conta a receber'),(17,'iFrmFormasPagamento','cadastro de forma de pagamento'),(18,'iFrmCadPessoa','cadastro de pessoa'),(19,'iFrmCadTipoUsuario','cadastro de tipos de usuário'),(20,'iFrmCadUsuario','cadastro de usuário'),(21,'FrmLogin','login do sistema'),(22,'FrmPrincipal','tela principal do sistema'),(23,'iFrmPermTipoUsuario','permissão tipo de usuário'),(24,'iFrmConfiguracoes','configurações do sistema'),(25,'iFrmBackup','backup do sistema'),(26,'caixaCofre','caixa tipo cofre'),(27,'iFrmHistorico','histórico de usuário'),(28,'historicoGeral','histórico geral dos usuários'),(29,'iFrmDespesas','controle de despesas e movimento de caixa'),(30,'iFrm_rep_cliente_geral','relatório de clientes geral com contatos'),(31,'iFrmCancelarVenda','cancelamento de venda'),(32,'iFrm_rep_comissao','relatório de comissão'),(33,'iFrm_rep_lancamentos_conta_receber','relatório de contas a receber'),(34,'iFrm_rep_lancamentos_conta_pagar','relatório de contas a pagar'),(35,'iFrm_rep_producao_tinta','relatório de produção de tinta'),(36,'iFrm_rep_funcionarios_geral','relatório de funcionarios geral com contatos'),(37,'iFrm_rep_fornecedores_geral','relatório de fornecedores geral com contatos'),(38,'iFrm_rep_vendas_total','relatório de vendas totais'),(39,'iFrm_rep_produtos_vendidos','relatório de produtos vendidos'),(40,'rep_produtos_simples','relatório de produtos simples'),(41,'iFrm_rep_produtos_completo','relatório de produtos completo'),(42,'iFrm_rep_historico','relatório de histórico'),(43,'iFrm_rep_usuarios','relatório de usuários'),(44,'iFrm_rep_caixas','relatório de caixas'),(45,'iFrm_rep_controle_ch_ct','relatório de cheque e cartão'),(46,'iFrm_rep_despesas','relatório de despesas e lançamentos de caixa'),(47,'iFrm_rep_vendas_melhores_compradores','relatório de clientes que mais compraram'),(48,'iFrm_rep_promocoes','relatório de promoções'),(49,'iFrm_rep_compras_total','relatório de compras totais');
...
DROP TABLE IF EXISTS `tarefas_tipo_usuario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tarefas_tipo_usuario` (
  ...
  KEY `id_tarefa` (`id_tarefa`),
  CONSTRAINT `fk_tarefas_1` FOREIGN KEY (`id_tarefa`) REFERENCES `tarefas` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_tipo_usuario_1` FOREIGN KEY (`id_tipo_usuario`) REFERENCES `tipos_usuario` (`id`) ON UPDATE CASCADE
...
LOCK TABLES `tarefas_tipo_usuario` WRITE;
/*!40000 ALTER TABLE `tarefas_tipo_usuario` DISABLE KEYS */;
INSERT INTO `tarefas_tipo_usuario` VALUES (14,2,15,1,1,1,'2016-10-29 18:25:05','2016-10-29 18:25:05'),(15,2,16,1,1,1,'2016-10-29 18:25:05','2016-10-29 18:25:05'),(16,2,14,1,1,1,'2016-10-29 18:25:05','2016-10-29 18:25:05'),(17,2,13,1,1,1,'2016-10-29 18:25:05','2016-10-29 18:25:05'),(18,3,17,1,1,1,'2016-10-29 18:27:23','2016-10-29 18:27:23'),(19,3,6,1,1,1,'2016-10-29 18:27:23','2016-10-29 18:27:23'),(20,3,18,1,1,1,'2016-10-29 18:27:23','2016-10-29 18:27:23'),(21,3,12,0,0,1,'2016-10-29 18:27:23','2016-10-29 18:27:23'),(22,4,12,1,1,0,'2016-10-29 18:31:01','2016-10-29 18:31:01'),(23,4,18,1,0,0,'2016-10-29 18:31:01','2016-10-29 18:31:01'),(24,4,5,1,0,0,'2016-10-29 18:31:01','2016-10-29 18:31:01'),(25,5,5,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(26,5,7,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(27,5,10,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(28,5,18,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(29,5,8,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(30,5,2,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(31,5,4,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(32,5,3,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(33,5,1,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(34,5,9,1,1,1,'2016-10-29 18:36:56','2016-10-29 18:36:56'),(35,6,5,1,0,0,'2016-10-29 18:40:37','2016-10-29 18:40:37'),(36,8,13,1,1,1,'2016-10-29 18:41:18','2016-10-29 23:44:29'),(37,7,7,1,1,0,'2016-10-29 18:43:11','2016-10-29 18:54:26'),(38,7,5,1,0,0,'2016-10-29 18:43:11','2016-10-29 18:55:19'),(39,7,11,1,1,1,'2016-10-29 18:43:11','2016-10-29 19:00:37'),(40,1,1,1,0,0,'2016-10-30 11:33:50','2016-10-30 11:33:50'),(41,1,2,1,0,0,'2016-10-30 11:35:01','2016-10-30 11:35:01'),(42,1,3,1,0,0,'2016-10-30 11:35:07','2016-10-30 11:35:07'),(43,1,4,1,0,0,'2016-10-30 11:35:13','2016-10-30 11:35:13'),(44,1,5,1,0,0,'2016-10-30 11:35:18','2016-10-30 11:35:18'),(45,1,6,1,0,0,'2016-10-30 11:36:18','2016-10-30 11:36:18'),(46,1,7,1,0,0,'2016-10-30 11:38:34','2016-10-30 11:38:34'),(47,1,8,1,0,0,'2016-10-30 11:38:47','2016-10-30 11:38:47'),(48,1,9,1,0,0,'2016-10-30 11:38:55','2016-10-30 11:38:55'),(49,1,10,1,0,0,'2016-10-30 11:39:08','2016-10-30 11:39:08'),(50,1,11,1,0,0,'2016-10-30 11:39:18','2016-10-30 11:39:18'),(51,1,12,1,0,0,'2016-10-30 11:39:30','2016-10-30 11:39:30'),(52,1,13,1,0,0,'2016-10-30 11:39:42','2016-11-04 02:26:10'),(53,1,14,1,0,0,'2016-10-30 11:39:50','2016-10-30 11:39:50'),(54,1,15,1,0,0,'2016-10-30 11:40:04','2016-11-08 22:06:21'),(55,1,16,1,0,0,'2016-10-30 11:40:30','2016-10-30 11:40:30'),(56,1,17,1,0,0,'2016-10-30 11:41:28','2016-10-30 11:41:28'),(57,1,18,1,0,0,'2016-10-30 11:41:35','2016-10-30 11:41:35'),(58,1,19,1,0,0,'2016-10-30 11:42:10','2016-10-30 11:42:10'),(59,1,20,1,0,0,'2016-10-30 11:42:18','2016-10-30 11:42:18'),(60,1,23,1,0,0,'2016-10-30 11:42:25','2016-11-02 11:47:58'),(61,1,24,1,0,0,'2016-10-31 17:07:51','2016-10-31 17:07:51'),(62,1,25,1,0,0,'2016-11-01 16:41:43','2016-11-02 11:47:23'),(63,1,26,0,0,0,'2016-11-04 01:19:57','2016-11-20 19:22:41'),(65,4,17,1,0,0,'2016-11-08 00:39:23','2016-11-08 00:39:23'),(66,1,27,1,0,0,'2016-11-11 16:57:29','2016-11-11 16:57:29'),(67,1,29,1,0,0,'2016-11-12 22:21:50','2016-11-12 22:21:50'),(68,1,31,1,0,0,'2016-11-15 16:01:22','2016-11-15 16:01:22'),(69,4,32,1,0,0,'2016-11-15 22:12:09','2016-11-15 22:12:09'),(70,1,44,1,0,0,'2016-11-20 19:21:18','2016-11-20 19:21:18');
/*!40000 ALTER TABLE `tarefas_tipo_usuario` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tintas` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_tintas_tipos_tinta1_idx` (`id_tipo_tinta`),
  KEY `fk_tintas_categorias_tinta1_idx` (`id_categoria_tinta`),
  KEY `fk_tintas_montadoras1_idx` (`sigla_montadora`),
  KEY `fk_tintas_unidades1_idx` (`sigla_unidade`),
  CONSTRAINT `fk_tintas_categorias_tinta1` FOREIGN KEY (`id_categoria_tinta`) REFERENCES `categorias_tinta` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tintas_montadoras1` FOREIGN KEY (`sigla_montadora`) REFERENCES `montadoras` (`sigla`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tintas_tipos_tinta1` FOREIGN KEY (`id_tipo_tinta`) REFERENCES `tipos_tinta` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tintas_unidades1` FOREIGN KEY (`sigla_unidade`) REFERENCES `unidades` (`sigla`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tintas` VALUES (1,'branco geada','vw40000',1995,2011,2,1,'vw',3.600,0.160,'lt','2016-10-23 23:38:22','2016-10-24 00:36:53'),(2,'vermelho ferrari','fi30002',1978,1979,2,1,'fi',3.600,0.020,'lt','2016-11-16 14:24:42','2016-11-16 14:24:42'),(3,'branco star II','vw40001',1989,1994,2,1,'vw',3.600,0.100,'lt','2016-11-16 14:32:20','2016-11-16 14:32:20'),(4,'azul oceania','frd50027',2001,2001,2,1,'fd',3.600,0.020,'lt','2016-11-16 14:36:41','2016-11-16 14:36:41');
...
DROP TABLE IF EXISTS `tipos_tinta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `tipos_tinta` WRITE;
/*!40000 ALTER TABLE `tipos_tinta` DISABLE KEYS */;
INSERT INTO `tipos_tinta` VALUES (1,'esmalte sintético','2016-10-03 18:51:53','2016-10-03 18:51:53'),(2,'poliester','2016-10-03 18:51:53','2016-10-03 18:51:53'),(3,'poliuretano(PU)','2016-10-03 18:53:08','2016-10-03 18:53:08'),(4,'lacanitrocelulose(DUCO)','2016-10-03 18:53:08','2016-10-03 18:53:08');
/*!40000 ALTER TABLE `tipos_tinta` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tipos_usuario` VALUES (1,'administrador','2016-09-19 18:11:02','2016-09-19 18:05:17'),(2,'gerente financeiro','2016-09-19 18:08:41','2016-09-19 18:08:41'),(3,'gerente de vendas','2016-09-19 18:18:30','2016-09-19 18:18:30'),(4,'vendedor','2016-09-19 18:16:27','2016-09-19 18:29:25'),(5,'comprador','2016-09-19 18:26:07','2016-09-19 18:27:31'),(6,'estoquista','2016-09-19 18:30:49','2016-09-19 18:30:49'),(7,'colorista','2016-10-29 18:37:27','2016-10-29 18:37:27'),(8,'caixa','2016-10-29 18:38:56','2016-10-29 18:38:56');
...
INSERT INTO `unidades` VALUES ('cj','conjunto','2016-10-06 12:48:13','2016-10-06 13:04:02'),('fl','folha','2016-10-30 00:40:19','2016-10-30 00:40:19'),('gr','grama','2016-10-03 17:33:30','2016-10-03 17:33:30'),('lt','litro','2016-10-06 17:09:26','2016-10-18 15:42:54'),('ml','mililitro','2016-10-03 17:33:30','2016-10-03 17:33:30'),('oz','onça','2016-10-03 17:34:47','2016-10-03 19:31:36'),('pc','peça','2016-10-03 17:33:05','2016-10-03 17:33:05'),('un','unidade','2016-10-08 18:00:47','2016-10-08 18:00:47');
...
CREATE TABLE `usuarios` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`nome`),
  KEY `fk_usuarios_tipos_usuario1_idx1` (`tipo`),
  KEY `fk_usuarios_pessoas1_idx` (`doc_principal_funcionario`),
  CONSTRAINT `fk_usuarios_pessoas1` FOREIGN KEY (`doc_principal_funcionario`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_usuarios_tipos_usuario1` FOREIGN KEY (`tipo`) REFERENCES `tipos_usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES ('admin','8D969EEF6ECAD3C29A3A','43899351193',1,NULL,1,'2016-09-19 23:09:15','2017-02-27 16:24:10');
...
CREATE TABLE `vendas` (
  ...
  `data_modificacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_vendas_pessoas1_idx` (`doc_principal_cliente`),
  KEY `fk_vendas_usuarios1_idx` (`nome_usuario`),
  CONSTRAINT `fk_vendas_pessoas1` FOREIGN KEY (`doc_principal_cliente`) REFERENCES `pessoas` (`doc_principal`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_vendas_usuarios1` FOREIGN KEY (`nome_usuario`) REFERENCES `usuarios` (`nome`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `vw_bases_tinta`
--

DROP TABLE IF EXISTS `vw_bases_tinta`;
/*!50001 DROP VIEW IF EXISTS `vw_bases_tinta`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_bases_tinta` (
  `id` tinyint NOT NULL,
  `id_tinta` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `cod_base` tinyint NOT NULL,
  `quantidade` tinyint NOT NULL,
  `sigla_unidade` tinyint NOT NULL,
  `data_inclusao_base` tinyint NOT NULL,
  `data_modificacao_base` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_bases_tinta_producao`
--

DROP TABLE IF EXISTS `vw_bases_tinta_producao`;
/*!50001 DROP VIEW IF EXISTS `vw_bases_tinta_producao`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_bases_tinta_producao` (
  `id` tinyint NOT NULL,
  `id_tinta` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome_base` tinyint NOT NULL,
  `cod_base` tinyint NOT NULL,
  `quantidade` tinyint NOT NULL,
  `unidade_base_producao` tinyint NOT NULL,
  `quant_unit_base_producao` tinyint NOT NULL,
  `unid_quant_unitaria` tinyint NOT NULL,
  `quantidade_producao` tinyint NOT NULL,
  `comissao` tinyint NOT NULL,
  `simples_nacional` tinyint NOT NULL,
  `preco_custo` tinyint NOT NULL,
  `preco_venda` tinyint NOT NULL,
  `razao_unidades` tinyint NOT NULL,
  `estoque_atual` tinyint NOT NULL,
  `marca_produto` tinyint NOT NULL,
  `data_inclusao_base` tinyint NOT NULL,
  `data_modificacao_base` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_caixa_consulta_conta_pagar`
--

DROP TABLE IF EXISTS `vw_caixa_consulta_conta_pagar`;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_consulta_conta_pagar`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_caixa_consulta_conta_pagar` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `tipo` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Temporary table structure for view `vw_caixa_consulta_conta_receber`
--

DROP TABLE IF EXISTS `vw_caixa_consulta_conta_receber`;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_consulta_conta_receber`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_caixa_consulta_conta_receber` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `tipo` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Temporary table structure for view `vw_caixa_consulta_venda`
--

DROP TABLE IF EXISTS `vw_caixa_consulta_venda`;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_consulta_venda`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_caixa_consulta_venda` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_caixa_tipo`
--

DROP TABLE IF EXISTS `vw_caixa_tipo`;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_tipo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_caixa_tipo` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_clientes_pesquisa_venda`
--

DROP TABLE IF EXISTS `vw_clientes_pesquisa_venda`;
/*!50001 DROP VIEW IF EXISTS `vw_clientes_pesquisa_venda`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_clientes_pesquisa_venda` (
  `doc_principal` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `data_nascimento` tinyint NOT NULL,
  `limite_credito` tinyint NOT NULL
...
--
-- Temporary table structure for view `vw_contas_pagar_pesquisa`
--

DROP TABLE IF EXISTS `vw_contas_pagar_pesquisa`;
/*!50001 DROP VIEW IF EXISTS `vw_contas_pagar_pesquisa`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_contas_pagar_pesquisa` (
  `doc` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `fantasia` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_contas_receber_pesquisa`
--

DROP TABLE IF EXISTS `vw_contas_receber_pesquisa`;
/*!50001 DROP VIEW IF EXISTS `vw_contas_receber_pesquisa`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_contas_receber_pesquisa` (
  `doc` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `fantasia` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Temporary table structure for view `vw_controle_cheque_cartao_especie`
--

DROP TABLE IF EXISTS `vw_controle_cheque_cartao_especie`;
/*!50001 DROP VIEW IF EXISTS `vw_controle_cheque_cartao_especie`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_controle_cheque_cartao_especie` (
  `id` tinyint NOT NULL,
  `doc_principal_pessoa` tinyint NOT NULL,
  `nome_pessoa` tinyint NOT NULL,
  `id_conta_receber` tinyint NOT NULL,
  `dados_adicionais` tinyint NOT NULL,
  `valor_total` tinyint NOT NULL,
  `id_item_caixa` tinyint NOT NULL,
  ...
  `desc_especie` tinyint NOT NULL,
  `quantidade_parcelas` tinyint NOT NULL,
  `quantidade_parcelas_abertas` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_controle_cheque_cartao_especie_aberto`
--

DROP TABLE IF EXISTS `vw_controle_cheque_cartao_especie_aberto`;
/*!50001 DROP VIEW IF EXISTS `vw_controle_cheque_cartao_especie_aberto`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_controle_cheque_cartao_especie_aberto` (
  `id` tinyint NOT NULL,
  `doc_principal_pessoa` tinyint NOT NULL,
  `nome_pessoa` tinyint NOT NULL,
  `id_conta_receber` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_formas_pagamento`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_formas_pagamento` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `especie` tinyint NOT NULL,
  `desc_especie` tinyint NOT NULL,
  `numero_parcelas` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_formas_pagamento_finac`
--

DROP TABLE IF EXISTS `vw_formas_pagamento_finac`;
/*!50001 DROP VIEW IF EXISTS `vw_formas_pagamento_finac`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_formas_pagamento_finac` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `especie` tinyint NOT NULL,
  `desc_especie` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_fornecedores_pesquisa_compra`
--

DROP TABLE IF EXISTS `vw_fornecedores_pesquisa_compra`;
/*!50001 DROP VIEW IF EXISTS `vw_fornecedores_pesquisa_compra`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_fornecedores_pesquisa_compra` (
  `doc_principal` tinyint NOT NULL,
  `nome` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_historico`
--

DROP TABLE IF EXISTS `vw_historico`;
/*!50001 DROP VIEW IF EXISTS `vw_historico`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_historico` (
  `id` tinyint NOT NULL,
  `nome_usuario` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `id_tarefa` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_itens_caixa`
--

DROP TABLE IF EXISTS `vw_itens_caixa`;
/*!50001 DROP VIEW IF EXISTS `vw_itens_caixa`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_itens_caixa` (
  `id` tinyint NOT NULL,
  `id_caixa` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_itens_compras`
--

DROP TABLE IF EXISTS `vw_itens_compras`;
/*!50001 DROP VIEW IF EXISTS `vw_itens_compras`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_itens_compras` (
  `id` tinyint NOT NULL,
  `id_compra` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome_produto` tinyint NOT NULL,
  `quantidade` tinyint NOT NULL,
  `valor_custo_unitario` tinyint NOT NULL,
  `ipi` tinyint NOT NULL,
  `diferenca_icms` tinyint NOT NULL,
  `icms_st` tinyint NOT NULL,
  `frete` tinyint NOT NULL,
  `data_vencimento_produto` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_itens_vendas`
--

DROP TABLE IF EXISTS `vw_itens_vendas`;
/*!50001 DROP VIEW IF EXISTS `vw_itens_vendas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_itens_vendas` (
  `id` tinyint NOT NULL,
  `id_venda` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome_produto` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_itens_vendas_porcentagens`
--

DROP TABLE IF EXISTS `vw_itens_vendas_porcentagens`;
/*!50001 DROP VIEW IF EXISTS `vw_itens_vendas_porcentagens`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_itens_vendas_porcentagens` (
  `id_venda` tinyint NOT NULL,
  `data` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  ...
  `simples_nacional` tinyint NOT NULL,
  `margem` tinyint NOT NULL,
  `valor_custo_total` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vw_lancamentos_conta_pagar_pessoa`
--

DROP TABLE IF EXISTS `vw_lancamentos_conta_pagar_pessoa`;
/*!50001 DROP VIEW IF EXISTS `vw_lancamentos_conta_pagar_pessoa`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_lancamentos_conta_pagar_pessoa` (
  `id` tinyint NOT NULL,
  `id_conta_pagar` tinyint NOT NULL,
  `doc_principal_fornecedor` tinyint NOT NULL,
  `id_compra` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_lancamentos_conta_receber`
--

DROP TABLE IF EXISTS `vw_lancamentos_conta_receber`;
/*!50001 DROP VIEW IF EXISTS `vw_lancamentos_conta_receber`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_lancamentos_conta_receber` (
  `id` tinyint NOT NULL,
  `id_conta_receber` tinyint NOT NULL,
  `id_item_caixa` tinyint NOT NULL,
  `valor` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_lancamentos_conta_receber_pessoa`
--

DROP TABLE IF EXISTS `vw_lancamentos_conta_receber_pessoa`;
/*!50001 DROP VIEW IF EXISTS `vw_lancamentos_conta_receber_pessoa`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_lancamentos_conta_receber_pessoa` (
  `id` tinyint NOT NULL,
  `id_conta_receber` tinyint NOT NULL,
  `doc_principal_cliente` tinyint NOT NULL,
  `id_venda` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_marcas`
--

DROP TABLE IF EXISTS `vw_marcas`;
/*!50001 DROP VIEW IF EXISTS `vw_marcas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_marcas` (
  `id` tinyint NOT NULL,
  `descricao` tinyint NOT NULL,
  `doc_principal_fornecedor` tinyint NOT NULL,
  `nome_fornecedor` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_produtos_base_tinta`
--

DROP TABLE IF EXISTS `vw_produtos_base_tinta`;
/*!50001 DROP VIEW IF EXISTS `vw_produtos_base_tinta`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_produtos_base_tinta` (
  `id` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `codigo_fornecedor` tinyint NOT NULL,
  `unidade_producao` tinyint NOT NULL
...
--
-- Temporary table structure for view `vw_promocoes`
--

DROP TABLE IF EXISTS `vw_promocoes`;
/*!50001 DROP VIEW IF EXISTS `vw_promocoes`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_promocoes` (
  `id` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `codigo_barra` tinyint NOT NULL,
  ...
  `valor_unitario` tinyint NOT NULL,
  `quantidade` tinyint NOT NULL,
  `valor_original` tinyint NOT NULL,
  `data_inicio` tinyint NOT NULL,
  `data_fim` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_promocoes_ativas`
--

DROP TABLE IF EXISTS `vw_promocoes_ativas`;
/*!50001 DROP VIEW IF EXISTS `vw_promocoes_ativas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_promocoes_ativas` (
  `id` tinyint NOT NULL,
  `id_produto` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `codigo_barra` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vw_tarefas_tipo_usuario`
--

DROP TABLE IF EXISTS `vw_tarefas_tipo_usuario`;
/*!50001 DROP VIEW IF EXISTS `vw_tarefas_tipo_usuario`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_tarefas_tipo_usuario` (
  `id` tinyint NOT NULL,
  `id_tipo_usuario` tinyint NOT NULL,
  `descricao_tipo_usuario` tinyint NOT NULL,
  `id_tarefa` tinyint NOT NULL,
  `nome_tarefa` tinyint NOT NULL,
  `descricao_tarefa` tinyint NOT NULL,
  `acesso` tinyint NOT NULL,
  `acesso_desc` tinyint NOT NULL,
  `gravacao` tinyint NOT NULL,
  `gravacao_desc` tinyint NOT NULL,
  `remocao` tinyint NOT NULL,
  `remocao_desc` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vw_tintas`
--

DROP TABLE IF EXISTS `vw_tintas`;
/*!50001 DROP VIEW IF EXISTS `vw_tintas`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_tintas` (
  `id` tinyint NOT NULL,
  `nome` tinyint NOT NULL,
  `cod_tinta` tinyint NOT NULL,
  `ano_inicial` tinyint NOT NULL,
  `ano_final` tinyint NOT NULL,
  `id_categoria_tinta` tinyint NOT NULL,
  `categoria` tinyint NOT NULL,
  `id_tipo_tinta` tinyint NOT NULL,
  `tipo` tinyint NOT NULL,
  `sigla_montadora` tinyint NOT NULL,
  `montadora` tinyint NOT NULL,
  `quantidade_producao` tinyint NOT NULL,
  `quantidade_minima` tinyint NOT NULL,
  `sigla_unidade` tinyint NOT NULL,
  `unidade` tinyint NOT NULL,
  `data_inclusao` tinyint NOT NULL,
  `data_modificacao` tinyint NOT NULL
...
--
-- Temporary table structure for view `vw_usuarios_pesquisa_historico`
--

DROP TABLE IF EXISTS `vw_usuarios_pesquisa_historico`;
/*!50001 DROP VIEW IF EXISTS `vw_usuarios_pesquisa_historico`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_usuarios_pesquisa_historico` (
  `nome_usuario` tinyint NOT NULL,
  `nome_pessoa` tinyint NOT NULL,
  `administrador` tinyint NOT NULL,
  `desc_tipo` tinyint NOT NULL,
...
--
-- Final view structure for view `rel_clientes_geral`
--

/*!50001 DROP TABLE IF EXISTS `rel_clientes_geral`*/;
/*!50001 DROP VIEW IF EXISTS `rel_clientes_geral`*/;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rep_clientes_geral` AS select `pessoas`.`doc_principal` AS `doc_principal`,`pessoas`.`doc_secundario` AS `doc_secundario`,(case `pessoas`.`tipo` when 0 then 'física' else 'jurídica' end) AS `tipo`,`pessoas`.`nome` AS `nome`,`pessoas`.`fantasia` AS `fantasia`,`pessoas`.`estado_civil` AS `estado_civil`,`pessoas`.`pessoa_autorizada` AS `pessoa_autorizada`,(case when isnull(`pessoas`.`data_nascimento`) then '' else convert(date_format(`pessoas`.`data_nascimento`,'%d/%m/%Y') using utf8mb4) end) AS `data_nascimento`,`pessoas`.`limite_credito` AS `limite_credito`,(case when isnull(`pessoas`.`cep_cidade_natal`) then '' else `pessoas`.`cep_cidade_natal` end) AS `cep_cidade_natal`,(case when isnull(`localidades`.`localidade`) then '' else `localidades`.`localidade` end) AS `localidade`,(case when isnull(`estados`.`nome_estado`) then '' else `estados`.`nome_estado` end) AS `estado`,`pessoas`.`data_inclusao` AS `data_inclusao`,`pessoas`.`data_modificacao` AS `data_modificacao` from ((`pessoas` left join `localidades` on((`pessoas`.`cep_cidade_natal` = `localidades`.`cep`))) left join `estados` on((`localidades`.`estado` = `estados`.`uf`))) where ((`pessoas`.`ativo` = 1) and (`pessoas`.`cliente` = 1)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rep_comissao`
--

/*!50001 DROP TABLE IF EXISTS `rep_comissao`*/;
/*!50001 DROP VIEW IF EXISTS `rep_comissao`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rep_funcionarios_geral` AS select `pessoas`.`doc_principal` AS `doc_principal`,`pessoas`.`doc_secundario` AS `doc_secundario`,(case `pessoas`.`tipo` when 0 then 'física' else 'jurídica' end) AS `tipo`,`pessoas`.`nome` AS `nome`,`pessoas`.`fantasia` AS `fantasia`,`pessoas`.`estado_civil` AS `estado_civil`,`pessoas`.`pessoa_autorizada` AS `pessoa_autorizada`,`pessoas`.`data_nascimento` AS `data_nascimento`,`pessoas`.`limite_credito` AS `limite_credito`,`pessoas`.`cep_cidade_natal` AS `cep_cidade_natal`,`localidades`.`localidade` AS `localidade`,`estados`.`nome_estado` AS `estado`,`pessoas`.`data_inclusao` AS `data_inclusao`,`pessoas`.`data_modificacao` AS `data_modificacao` from ((`pessoas` left join `localidades` on((`pessoas`.`cep_cidade_natal` = `localidades`.`cep`))) left join `estados` on((`localidades`.`estado` = `estados`.`uf`))) where ((`pessoas`.`ativo` = 1) and (`pessoas`.`funcionario` = 1)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rep_historico`
--

/*!50001 DROP TABLE IF EXISTS `rep_historico`*/;
/*!50001 DROP VIEW IF EXISTS `rep_historico`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rep_lancamentos_conta_receber` AS select `lancamentos_conta_receber`.`id` AS `id`,`lancamentos_conta_receber`.`id_conta_receber` AS `id_conta_receber`,`lancamentos_conta_receber`.`id_item_caixa` AS `id_item_caixa`,`contas_receber`.`id_venda` AS `id_venda`,`lancamentos_conta_receber`.`valor` AS `valor`,`lancamentos_conta_receber`.`id_forma_pagamento` AS `id_forma_pagamento`,`formas_pagamento`.`descricao` AS `descricao`,(case `itens_caixa`.`especie` when 0 then 'dinheiro' when 1 then 'cheque' when 2 then 'cartão' else 'crediário' end) AS `especie`,`lancamentos_conta_receber`.`data_vencimento` AS `data_vencimento`,(case when isnull(`lancamentos_conta_receber`.`data_pagamento`) then '' else convert(date_format(`lancamentos_conta_receber`.`data_pagamento`,'%d/%m/%Y') using utf8mb4) end) AS `data_pagamento` from (((`lancamentos_conta_receber` join `contas_receber` on((`lancamentos_conta_receber`.`id_conta_receber` = `contas_receber`.`id`))) join `formas_pagamento` on((`lancamentos_conta_receber`.`id_forma_pagamento` = `formas_pagamento`.`id`))) left join `itens_caixa` on((`lancamentos_conta_receber`.`id_item_caixa` = `itens_caixa`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rep_lancamentos_conta_receber_cliente`
--

/*!50001 DROP TABLE IF EXISTS `rep_lancamentos_conta_receber_cliente`*/;
/*!50001 DROP VIEW IF EXISTS `rep_lancamentos_conta_receber_cliente`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rep_pessoas` AS select `pessoas`.`doc_principal` AS `doc_principal`,`pessoas`.`doc_secundario` AS `doc_secundario`,(case `pessoas`.`tipo` when 0 then 'física' else 'jurídica' end) AS `tipo`,`pessoas`.`nome` AS `nome`,`pessoas`.`fantasia` AS `fantasia`,`pessoas`.`estado_civil` AS `estado_civil`,`pessoas`.`pessoa_autorizada` AS `pessoa_autorizada`,(case when isnull(`pessoas`.`data_nascimento`) then '' else convert(date_format(`pessoas`.`data_nascimento`,'%d/%m/%Y') using utf8mb4) end) AS `data_nascimento`,`pessoas`.`limite_credito` AS `limite_credito`,(case when isnull(`pessoas`.`cep_cidade_natal`) then '' else `pessoas`.`cep_cidade_natal` end) AS `cep_cidade_natal`,(case when isnull(`localidades`.`localidade`) then '' else `localidades`.`localidade` end) AS `localidade`,(case when isnull(`estados`.`nome_estado`) then '' else `estados`.`nome_estado` end) AS `estado`,`pessoas`.`data_inclusao` AS `data_inclusao`,`pessoas`.`data_modificacao` AS `data_modificacao` from ((`pessoas` left join `localidades` on((`pessoas`.`cep_cidade_natal` = `localidades`.`cep`))) left join `estados` on((`localidades`.`estado` = `estados`.`uf`))) where (`pessoas`.`ativo` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rep_producao_tinta`
--

/*!50001 DROP TABLE IF EXISTS `rep_producao_tinta`*/;
/*!50001 DROP VIEW IF EXISTS `rep_producao_tinta`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rep_vendas` AS select `vendas`.`id` AS `id`,`vendas`.`data` AS `data`,`vendas`.`doc_principal_cliente` AS `doc_principal_cliente`,`pessoas`.`nome` AS `nome`,`vendas`.`nome_usuario` AS `nome_usuario` from (`vendas` join `pessoas` on((`vendas`.`doc_principal_cliente` = `pessoas`.`doc_principal`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rep_vendas_total`
--

/*!50001 DROP TABLE IF EXISTS `rep_vendas_total`*/;
/*!50001 DROP VIEW IF EXISTS `rep_vendas_total`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_caixa_consulta_conta_pagar` AS select `caixas`.`id` AS `id`,`caixas`.`descricao` AS `descricao`,`caixas`.`tipo` AS `tipo` from `caixas` where ((`caixas`.`tipo` = 1) and isnull(`caixas`.`data_fechamento`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_caixa_consulta_conta_receber`
--

/*!50001 DROP TABLE IF EXISTS `vw_caixa_consulta_conta_receber`*/;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_consulta_conta_receber`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_caixa_consulta_conta_receber` AS select `caixas`.`id` AS `id`,`caixas`.`descricao` AS `descricao`,`caixas`.`tipo` AS `tipo` from `caixas` where isnull(`caixas`.`data_fechamento`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_caixa_consulta_venda`
--

/*!50001 DROP TABLE IF EXISTS `vw_caixa_consulta_venda`*/;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_consulta_venda`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_caixa_consulta_venda` AS select `caixas`.`id` AS `id`,`caixas`.`descricao` AS `descricao` from `caixas` where ((`caixas`.`tipo` = 0) and isnull(`caixas`.`data_fechamento`) and (cast(`caixas`.`data_abertura` as date) = cast(now() as date))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_caixa_tipo`
--

/*!50001 DROP TABLE IF EXISTS `vw_caixa_tipo`*/;
/*!50001 DROP VIEW IF EXISTS `vw_caixa_tipo`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_clientes_pesquisa_venda` AS select `pessoas`.`doc_principal` AS `doc_principal`,`pessoas`.`nome` AS `nome`,`pessoas`.`data_nascimento` AS `data_nascimento`,`pessoas`.`limite_credito` AS `limite_credito` from `pessoas` where ((`pessoas`.`ativo` = 1) and (`pessoas`.`cliente` = 1)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_contas_pagar_pesquisa`
--

/*!50001 DROP TABLE IF EXISTS `vw_contas_pagar_pesquisa`*/;
/*!50001 DROP VIEW IF EXISTS `vw_contas_pagar_pesquisa`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_contas_pagar_pesquisa` AS select distinct `contas_pagar`.`doc_principal_fornecedor` AS `doc`,`pessoas`.`nome` AS `nome`,`pessoas`.`fantasia` AS `fantasia` from (`contas_pagar` join `pessoas` on((`contas_pagar`.`doc_principal_fornecedor` = `pessoas`.`doc_principal`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_contas_receber_pesquisa`
--

/*!50001 DROP TABLE IF EXISTS `vw_contas_receber_pesquisa`*/;
/*!50001 DROP VIEW IF EXISTS `vw_contas_receber_pesquisa`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_contas_receber_pesquisa` AS select distinct `contas_receber`.`doc_principal_cliente` AS `doc`,`pessoas`.`nome` AS `nome`,`pessoas`.`fantasia` AS `fantasia` from (`contas_receber` join `pessoas` on((`contas_receber`.`doc_principal_cliente` = `pessoas`.`doc_principal`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_controle_cheque_cartao_especie`
--

/*!50001 DROP TABLE IF EXISTS `vw_controle_cheque_cartao_especie`*/;
/*!50001 DROP VIEW IF EXISTS `vw_controle_cheque_cartao_especie`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE IF EXISTS `vw_formas_pagamento`*/;
/*!50001 DROP VIEW IF EXISTS `vw_formas_pagamento`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
--
-- Final view structure for view `vw_formas_pagamento_finac`
--

/*!50001 DROP TABLE IF EXISTS `vw_formas_pagamento_finac`*/;
/*!50001 DROP VIEW IF EXISTS `vw_formas_pagamento_finac`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_formas_pagamento_finac` AS select `formas_pagamento`.`id` AS `id`,`formas_pagamento`.`descricao` AS `descricao`,`formas_pagamento`.`especie` AS `especie`,(case `formas_pagamento`.`especie` when 0 then 'dh' when 1 then 'ch' when 2 then 'ct' when 3 then 'crediário' end) AS `desc_especie`,`formas_pagamento`.`numero_parcelas` AS `numero_parcelas`,`formas_pagamento`.`prazo` AS `prazo`,`formas_pagamento`.`juros` AS `juros`,`formas_pagamento`.`data_inclusao` AS `data_inclusao`,`formas_pagamento`.`data_modificacao` AS `data_modificacao` from `formas_pagamento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_fornecedores_pesquisa_compra`
--

/*!50001 DROP TABLE IF EXISTS `vw_fornecedores_pesquisa_compra`*/;
/*!50001 DROP VIEW IF EXISTS `vw_fornecedores_pesquisa_compra`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_fornecedores_pesquisa_compra` AS select `pessoas`.`doc_principal` AS `doc_principal`,`pessoas`.`nome` AS `nome` from `pessoas` where ((`pessoas`.`ativo` = 1) and (`pessoas`.`fornecedor` = 1)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_historico`
--

/*!50001 DROP TABLE IF EXISTS `vw_historico`*/;
/*!50001 DROP VIEW IF EXISTS `vw_historico`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
--
-- Final view structure for view `vw_produtos_base_tinta`
--

/*!50001 DROP TABLE IF EXISTS `vw_produtos_base_tinta`*/;
/*!50001 DROP VIEW IF EXISTS `vw_produtos_base_tinta`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_produtos_base_tinta` AS select `vw_produtos`.`id` AS `id`,`vw_produtos`.`nome` AS `nome`,`vw_produtos`.`codigo_fornecedor` AS `codigo_fornecedor`,`vw_produtos`.`unidade_producao` AS `unidade_producao` from `vw_produtos` where (`vw_produtos`.`id_categoria` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_promocoes`
--

/*!50001 DROP TABLE IF EXISTS `vw_promocoes`*/;
/*!50001 DROP VIEW IF EXISTS `vw_promocoes`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`orions`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_usuarios` AS select `usuarios`.`nome` AS `nome`,`usuarios`.`senha` AS `senha`,`usuarios`.`administrador` AS `administrador`,`usuarios`.`tipo` AS `tipo`,`tipos_usuario`.`descricao` AS `descricao_tipo` from (`usuarios` left join `tipos_usuario` on((`usuarios`.`tipo` = `tipos_usuario`.`id`))) where (`usuarios`.`ativo` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_usuarios_pesquisa_historico`
--

/*!50001 DROP TABLE IF EXISTS `vw_usuarios_pesquisa_historico`*/;
/*!50001 DROP VIEW IF EXISTS `vw_usuarios_pesquisa_historico`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
-- Dump completed on 2017-02-27 13:38:24
