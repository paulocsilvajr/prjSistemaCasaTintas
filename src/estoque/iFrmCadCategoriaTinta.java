 ...
 * @author patri
 */
public class iFrmCadCategoriaTinta extends javax.swing.JInternalFrame {
    private JDBQuery qryCatTinta;
    private boolean alteracao = false;
    private String id;
    /**
     * Creates new form iFrmCadCategoriaProd
     */
    public iFrmCadCategoriaTinta() {
        qryCatTinta = new JDBQuery();
        qryCatTinta.setJDBConnection(principal.Principal.conexao.getConexao());
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Cadastro de Categorias de Tinta");
...
//        int[] tamanho = {200, 400};
        ...
        pesquisa.iFrmPesquisa catTinta;
        catTinta = new pesquisa.iFrmPesquisa(this,
                "Pesquisa de Categorias de tinta",
                principal.Principal.conexao.getConexao(),
                qryCatTinta,
                "id",
                combo,
                titulo,
                "SELECT id, descricao, data_inclusao, data_modificacao FROM categorias_tinta",
                invisivel,
                null);

        
        principal.FrmPrincipal.Desktop.add(catTinta);
        catTinta.setVisible(true);        
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if(FrmLogin.usuario.verificarPermissao(this, 1)){
            ...
            if(txtDesc.getText().isEmpty()){
                JOptionPane.showMessageDialog(iFrmCadCategoriaTinta.this, 
                ...
                String sql;
                if(alteracao){
                    if(sistema.Mensagem.showConfirmDialog(iFrmCadCategoriaTinta.this,
                        "Deseja realmente alterar esta categoria de tinta?", "Confirmação") == 0){

                        sql = String.format(
                              "UPDATE categorias_tinta "
                              + "SET descricao='%s' "
                              + "WHERE id = '%s'", 
                              txtDesc.getText(),
                              id);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if(FrmLogin.usuario.verificarPermissao(this, 2)){
            ...
            if(alteracao){
                if(sistema.Mensagem.showConfirmDialog(iFrmCadCategoriaTinta.this,
                        "Deseja realmente excluir esta categoria de tinta?", "Confirmação") == 0){

                    String sql = String.format("DELETE FROM categorias_tinta WHERE id = '%s'", id);
                ...
                JOptionPane.showMessageDialog(iFrmCadCategoriaTinta.this, 
                        "Consulte uma categoria de tinta para excluir", "Atenção", 
                        JOptionPane.INFORMATION_MESSAGE);
    ...
    public void atribuirCampos(){
        ...
        id = qryCatTinta.getCurrentFieldValueAsString("id");
        descricao = qryCatTinta.getCurrentFieldValueAsString("descricao");
        inclusao = qryCatTinta.getCurrentFieldValueAsString("data_inclusao");
        modificacao = qryCatTinta.getCurrentFieldValueAsString("data_modificacao");
        ...
        if(!concluido){
            ...
            if(transacao.getErrorCode() == 1451){
                JOptionPane.showMessageDialog(this, 
                        "Categoria de tinta com relacionamento, não pode ser excluída", "Atenção", 
                        JOptionPane.INFORMATION_MESSAGE);                
            }
        }
