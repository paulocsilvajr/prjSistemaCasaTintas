 ...
 * @author Ewerton
 */
public class iFrm_rep_cliente_geral extends javax.swing.JInternalFrame {

    /**
     * Creates new form iFrmCadUsuario
     */
    public iFrm_rep_cliente_geral() {
        initComponents();
    }
    //Mapa para o relatório
    ...
    private void initComponents() {
        ...
        conexaoRel = new lib.jdb.connection.JDBConnection();
        jqryRel = new lib.jdb.jdbquery.JDBQuery();
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            relatorio.Relatorios.rep_cliente_geral(
                    calDataInicio.getDateAsSQLDate(), 
                    calDataFim.getDateAsSQLDate());
            
            // registro de log
            FrmLogin.log.gravar(
                    FrmLogin.usuario.getNomeUsuario(), "iFrm_rep_cliente_geral", "emitido relatório");
        }
    ...
    private lib.jdb.connection.JDBConnection conexaoRel;
    private lib.jdb.jdbquery.JDBQuery jqryRel;
