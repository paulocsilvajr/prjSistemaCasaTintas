 ...
 * @author paulo
 */
public class iFrm_rep_compras_total extends javax.swing.JInternalFrame {
    private JDBQuery qryFornecedor;
    private String docFornecedor;
    
    /**
     * Creates new form iFrm_rep_compras_total
     */
    public iFrm_rep_compras_total() {
    ...
    private void initComponents() {
        ...
        txtCFornecedor = new javax.swing.JTextField();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Relatório de compras totais");
        ...
        txtCFornecedor.setFocusable(false);

        lblInc1.setFont(principal.FrmLogin.fontePadrao);
        lblInc1.setText("Fornecedor:");
        ...
        pnDatasLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnDatasLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnDatasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtCFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnConsultar)
                    .addComponent(btnTodos))
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        pessoa = new pesquisa.iFrmPesquisa(this,
            ...
            combo,
            titulo,
            "SELECT doc_principal, nome FROM vw_fornecedores_pesquisa_compra",
            invisivel,
            null);
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            ordenacao = "ORDER BY data, doc_principal_fornecedor";

            if(!txtCFornecedor.getText().isEmpty()){
                where += String.format(
                    "AND doc_principal_fornecedor = '%s' ",
                    docFornecedor);
            }

            where += ordenacao;

            relatorio.Relatorios.rep_compras_total(
                calDataInicio.getDateAsSQLDate(),
                calDataFim.getDateAsSQLDate(),
                where);
    ...
    private javax.swing.JTextField txtCFornecedor;
    // End of variables declaration//GEN-END:variables

    public void atribuirCampos(){
        docFornecedor = qryFornecedor.getCurrentFieldValueAsString("doc_principal");
        txtCFornecedor.setText(qryFornecedor.getCurrentFieldValueAsString("nome"));
    }
