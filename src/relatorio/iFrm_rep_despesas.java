 ...
 * @author paulo
 */
public class iFrm_rep_despesas extends javax.swing.JInternalFrame {
    private JDBQuery qryPessoa;
    private String docPessoa;
    
    /**
     * Creates new form iFrm_rep_despesas
     */
    public iFrm_rep_despesas() {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Relatório de despesas e lançamento de caixa");
        setName(""); // NOI18N
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            relatorio.Relatorios.rep_despesas(
                calDataInicio.getDateAsSQLDate(),
                calDataFim.getDateAsSQLDate(),
                where,
                titulo);
