 ...
 * @author paulo
 */
public class iFrm_rep_funcionarios_geral extends javax.swing.JInternalFrame {

    /**
     * Creates new form iFrm_rep_funcionarios_geral
     */
    public iFrm_rep_funcionarios_geral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Relatório de funcionários geral");
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            relatorio.Relatorios.rep_funcionarios_geral(
                calDataInicio.getDateAsSQLDate(),
                calDataFim.getDateAsSQLDate());

            // registro de log
            FrmLogin.log.gravar(
                FrmLogin.usuario.getNomeUsuario(), "iFrm_rep_funcionarios_geral", "emitido relatório");
        }
