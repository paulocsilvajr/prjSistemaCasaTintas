 ...
 * @author paulo
 */
public class iFrm_rep_lancamentos_conta_pagar extends javax.swing.JInternalFrame {
    private JDBQuery qryPessoa;
    private String docPessoa;
    
    /**
     * Creates new form iFrm_rep_lancamentos_conta_pagar
     */
    public iFrm_rep_lancamentos_conta_pagar() {
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            if(cbxTipo.getSelectedIndex() == 0){
                ...
                ordenacao = "ORDER BY doc_principal_fornecedor, data_vencimento ";
                titulo = "abertas";
            }else{
                ...
                where = String.format(
                    ...
                    calDataInicio.getDateAsSQLDate(),
                    calDataFim.getDateAsSQLDate());
                ordenacao = "ORDER BY doc_principal_fornecedor, data_pagamento ";
                titulo = "fechadas";
            }
            ...
            relatorio.Relatorios.rep_lancamentos_conta_pagar_fornecedor(
                calDataInicio.getDateAsSQLDate(),
                calDataFim.getDateAsSQLDate(),
                where,
                titulo);
            ...
            FrmLogin.log.gravar(
                ...
                "iFrm_rep_lancamentos_conta_pagar",
                docPessoa,
                "emitido relatório");
        }
    ...
    public void atribuirCampos(){
        ...
        txtFornecedor.setText(qryPessoa.getCurrentFieldValueAsString("nome"));
    }
}
