 ...
 * @author paulo
 */
public class iFrm_rep_venda_esp extends javax.swing.JInternalFrame {

    /**
     * Creates new form iFrm_rep_venda_esp
     */
    public iFrm_rep_venda_esp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblInc1.setText("Código da venda:");
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(txtCliente.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(this, "Código da venda deve ser formado somente por números", 
                    "Atenção", JOptionPane.INFORMATION_MESSAGE);
            txtCliente.requestFocus();
        }else{

            relatorio.Relatorios.rep_venda_esp(txtCliente.getText());
