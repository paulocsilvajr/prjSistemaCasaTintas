 ...
 * @author paulo
 */
public class iFrm_rep_vendas_melhores_compradores extends javax.swing.JInternalFrame {
    /**
     * Creates new form iFrm_rep_vendas_melhores_compradores
     */
    public iFrm_rep_vendas_melhores_compradores() {
        initComponents();
    }
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            where = String.format(
                "where (rep_vendas_total.data BETWEEN '%s' and '%s') ",
            ...
            relatorio.Relatorios.rep_vendas_melhores_compradores(
                calDataInicio.getDateAsSQLDate(),
                calDataFim.getDateAsSQLDate(),
                where,
                quantidade);
            ...
            FrmLogin.log.gravar(
                ...
                "iFrm_rep_vendas_melhores_compradores",
                "",
                "emitido relatório");
        }
