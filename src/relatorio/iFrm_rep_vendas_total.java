 ...
 * @author paulo
 */
public class iFrm_rep_vendas_total extends javax.swing.JInternalFrame {
    private JDBQuery qryPessoa;
    private String docPessoa;
    
    /**
     * Creates new form iFrm_rep_vendas_total
     */
    public iFrm_rep_vendas_total() {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Relatório de vendas totais");
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        if(calDataInicio.getText().isEmpty()){
            ...
            ordenacao = "ORDER BY data, doc_principal_cliente";
            ...
            relatorio.Relatorios.rep_vendas_total(
                calDataInicio.getDateAsSQLDate(),
                calDataFim.getDateAsSQLDate(),
                where);
